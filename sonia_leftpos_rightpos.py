...
class SoniaLeftposRightpos(Sonia):
	...
	def __init__(self, data_seqs = [], gen_seqs = [], chain_type = 'humanTRB', load_model = None, max_depth = 25, max_L = 30, include_genes = True,sample_gen=False,size_sample=int(5e4),custom_pgen_model=None):
