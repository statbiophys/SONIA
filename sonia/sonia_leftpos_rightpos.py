...
class SoniaLeftposRightpos(Sonia):
    ...
    def __init__(self, data_seqs = [], gen_seqs = [], chain_type = 'humanTRB',
                 ...
                 max_depth = 25, max_L = 30, include_indep_genes = False, include_joint_genes = True, min_energy_clip = -5, max_energy_clip = 10, seed = None,custom_pgen_model=None,l2_reg=0.,vj=False):
